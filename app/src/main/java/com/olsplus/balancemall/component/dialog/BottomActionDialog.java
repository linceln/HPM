...
public class BottomActionDialog extends Dialog {
    ...
    public BottomActionDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public BottomActionDialog create() {
            final BottomActionDialog dialog = new BottomActionDialog(p.context, shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            ...
            for (int i = 0; i < p.menuList.size(); i++) {
                ...
                bbm.setTextColor(Color.parseColor("#333333"));
                bbm.setTextSize(16);
