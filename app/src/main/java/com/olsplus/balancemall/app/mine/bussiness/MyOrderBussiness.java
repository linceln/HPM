...
import com.olsplus.balancemall.app.mine.bean.MyOrderDetailResult;
import com.olsplus.balancemall.app.mine.bean.MyOrderResult;
import com.olsplus.balancemall.app.mine.request.MyOrderService;
import com.olsplus.balancemall.app.mine.request.IMyOrderRequest;
...
public class MyOrderBussiness {
    ...
    public void getMyOrderListData(final String orderType, final String page, final String count, final IMyOrderRequest.GetMyOrderListCallback callback) {
        ...
        HttpResultObserver respObserver = new HttpResultObserver<MyOrderResult>() {
            ...
            @Override
            public void onSuccess(MyOrderResult data) {
                if (data == null) {
    ...
    public void getMyOrderDetailData(final String orderId, final IMyOrderRequest.GetMyOrderDetailCallback callback) {
        ...
        HttpResultObserver respObserver = new HttpResultObserver<MyOrderDetailResult>() {
            ...
            @Override
            public void onSuccess(MyOrderDetailResult data) {
                if (data == null) {
...
//
//            @Override
//            public void onSuccess(ReturnImgResult data) {
//                if (data == null) {
