package com.olsplus.balancemall.app.mine.bussiness;


import android.content.Context;

import com.olsplus.balancemall.app.merchant.goods.bean.ImageUploadEntity;
import com.olsplus.balancemall.app.mine.bean.FeedBackResult;
import com.olsplus.balancemall.app.mine.bean.MySeesionEntity;
import com.olsplus.balancemall.app.mine.bean.UpdateGenderResultEntity;
import com.olsplus.balancemall.app.mine.request.IMyStoreDataRequest;
import com.olsplus.balancemall.app.mine.request.UserService;
...
public class UserBusiness {
    ...
    public void getMyseesionData(final IMyStoreDataRequest.GetMySeesionCallback callback) {
        ...
        HttpResultObserver respObserver = new HttpResultObserver<MySeesionEntity>() {
            ...
            @Override
            public void onSuccess(MySeesionEntity data) {
                if (data == null) {
...
//
//            @Override
//            public void onSuccess(AvatarResultEntity data) {
//                if (data == null) {
...
//    }
    ...
    public void updateGender(final String gender, final IMyStoreDataRequest.UpdateGenderCallback callback) {
        ...
        HttpResultObserver respObserver = new HttpResultObserver<UpdateGenderResultEntity>() {
            ...
            @Override
            public void onSuccess(UpdateGenderResultEntity data) {
                if (data == null) {
