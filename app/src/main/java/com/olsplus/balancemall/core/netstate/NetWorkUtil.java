...
public class NetWorkUtil
{
	...
	{
		wifi, CMNET, CMWAP, noneNet,ETHERNET,BreakNet
	}
...
//		Toast.makeText(context, "nType:::"+nType, Toast.LENGTH_LONG).show();
